      ...
      projectFor = system:
        ...
        (nixpkgsFor system).haskell-nix.cabalProject' {
          ...
          shell = {
            ...
            tools = {
              cabal-fmt = { };
              # Must use haskell.nix, because the compiler version should match 
              # Also uses a version that fixes https://github.com/haskell/haskell-language-server/issues/2396
